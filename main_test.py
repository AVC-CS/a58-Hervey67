...
@pytest.mark.T2
def test_main_2():
    # data2.txt: 5 students (Canvas example): Kathy 100 90, Mary 100 100, Hammond 100 90, Maxine 90 90, Heather 100 90
    # Kathy sum=190 avg=95, Mary sum=200 avg=100, Hammond sum=190 avg=95
...
def test_main_3():
    ...
    # Jim sum=160 avg=80, Kate sum=185 avg=92.5
...
def test_main_4():
    ...
    # Tom sum=130 avg=65, Emma sum=200 avg=100
